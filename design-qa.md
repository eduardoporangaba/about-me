...
- state: GitHub idle, Instagram focus/active, menu open, mobile compact
...
- Copy and content: passed for `GitHub`, `Instagram`, `Linkedin`, `Saber mais`, `Contato`, and `DuDudu&Edu`.
